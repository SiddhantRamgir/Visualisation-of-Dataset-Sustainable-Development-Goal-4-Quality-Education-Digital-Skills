# Visualisation-of-Dataset-Sustainable-Development-Goal-4-Quality-Education-Digital-Skills
...
- **Where did you get the idea/code for this concept/implementation?**
  The idea and code were inspired by the MTU Innovation Challenge for Sustainable Development Goals.
  
- **Has anyone else published visualizations (on the internet etc.) for this dataset?**
  Yes, basic visualizations are available on Eurostat and MacroTrends websites as referenced.
  
- **What is novel about your approach in this assignment?**
  The study integrates gender-based analysis and regional variations using diverse visualization techniques.
  
- **Detail at least one complex concept/implementation in your work?**
  Spider plots for visualizing gender-based digital skills across countries are a complex yet insightful implementation.
  
- **Discuss at least three theoretical/design considerations/choices you made.**
  - Visualization choice: Selected diverse plots for comprehensive data representation.
  - Temporal analysis: Included time series to track economic and educational trends.
  - Comparative analysis: Compared economic indicators between Ireland and the Netherlands.
  
- **What aspect of data analysis did you investigate?**
  Primarily pattern recognition and comparative analysis of digital skills and economic indicators.
  
- **Given more time, how can your work be improved?**
  Conduct deeper analysis of factors influencing digital skills trends and integrate more datasets for broader insights.
